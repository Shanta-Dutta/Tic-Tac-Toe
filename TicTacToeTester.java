...
{
    private static TicTacToeClass tester;

    public static void main( String[] args )
    {
        // constructor
        System.out.print("Checking constructor....................................................");
        tester = new TicTacToeClass();
        check( "numTurns()",    tester.numTurns(),    0 );
        check( "isWinner('X')", tester.isWinner('X'), false );
        check( "isWinner('O')", tester.isWinner('O'), false );
        check( "isCat()",       tester.isCat(),       false );
        check( "isFull()",      tester.isFull(),      false );
        ...
        for ( int r = -100; r<=100; r++ )
            ...
            {
                check( "isValid("+r+","+c+")", tester.isValid(r,c), ( 0 <= r && r < 3 && 0 <= c && c < 3 ) );
        ...
        while ( game[0] < 10 )
        {
            ...
            for ( byte b : game )
            {
                ...
                check( "numTurns()",   tester.numTurns(),    n );
                check( "isWinner('X')",tester.isWinner('X'), xWin );
                check( "isWinner('O')",tester.isWinner('O'), oWin );
                check( "isCat()",      tester.isCat(),       gato );
                check( "isFull()",     tester.isFull(),      n == 9 );
